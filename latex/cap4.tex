...
Esta instalação foi realizada a partir da modificação do tutorial de instalação do ERP5 no SlapOs, \cite{ERP5-SLAPOS}, o qual passa por modificações frequentes em função da atulização desta ferramenta.
